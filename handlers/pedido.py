...
async def pedido(update, context):
    ...
    if _is_group(update):
        texto = (
            ...
            "Por lá você pode pedir novos <b>animes</b>, enviar sugestões e reportar erros.\n\n"
    ...
    texto = (
        f"📩 <b>Central de Pedidos — {BOT_BRAND}</b>\n\n"
        "Peça novos <b>animes</b>, envie sugestões ou reporte algum <b>erro</b> em um só lugar.\n\n"
